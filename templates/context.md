...
- Phase researcher — Reads decisions to focus research (e.g., "card layout" → research card component patterns)
...
- Phase researcher uses decisions to focus investigation
